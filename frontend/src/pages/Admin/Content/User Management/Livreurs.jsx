...
const Livreurs = () => {
  ...
  const formattedLivreurs = fournisseurs.map((item) => ({ ...item,
    actions: {
  ...
  return (
    <>
      <Header title="Livreurs" icon={Layers2Icon} parent="Gestion des produits" current="Livreurs" />
      <FilteredTable formActions={formActions} label={"livreurs"} datas={formattedLivreurs} />
    </>
  );
};
